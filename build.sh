...
if [ ! -d "$DIR_ROOT/vendor/extra" ]; then
...
echo -e ""
lunch "lineage_$DEVICE-ap3a-$BUILD_TYPE"
...
# Build signed rom package if specified
    ...
    mka otatools target-files-package "$CMD"
    ...
    sign_target_files_apks -o -d $KEY_MAPPINGS \
        ...
        --extra_apks com.android.hardware.authsecret.apex=$KEY_MAPPINGS/com.android.hardware.authsecret \
        ...
        --extra_apks com.android.nfcservices.apex=$KEY_MAPPINGS/com.android.nfcservices \
        ...
        --extra_apks com.android.profiling.apex=$KEY_MAPPINGS/com.android.profiling \
        ...
        --extra_apex_payload_key com.android.hardware.authsecret.apex=$KEY_MAPPINGS/com.android.hardware.authsecret.pem \
        ...
        --extra_apex_payload_key com.android.nfcservices.apex=$KEY_MAPPINGS/com.android.nfcservices.pem \
        ...
        --extra_apex_payload_key com.android.profiling.apex=$KEY_MAPPINGS/com.android.profiling.pem \
